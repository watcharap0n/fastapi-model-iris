# FastAPI Restful API Machine Learning Iris
...
![Alt text](https://github.com/watcharap0n/fastapi-model-iris/blob/main/static/github/img1.png?raw=true "Title")

**Preview API Prediction Iris**

![Alt text](https://github.com/watcharap0n/fastapi-model-iris/blob/main/static/github/img2.png?raw=true "Title")

**Preview API Predict detail**

![Alt text](https://github.com/watcharap0n/fastapi-model-iris/blob/main/static/github/img3.png?raw=true "Title")
